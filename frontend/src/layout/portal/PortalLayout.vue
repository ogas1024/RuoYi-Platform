...
<style scoped>
.portal-layout { height: 100vh; }
.portal-header { display: flex; align-items: center; gap: 16px; height: 56px; border-bottom: 1px solid #f0f0f0; }
.portal-header .left { display: flex; align-items: center; cursor: pointer; }
.portal-header .logo { font-weight: 700; font-size: 18px; color: #409EFF; }
.portal-header .crumb { flex: 1; margin-left: 20px; }
.portal-header .actions { white-space: nowrap; }
.portal-header .right { display: flex; align-items: center; gap: 12px; }
.portal-aside { border-right: 1px solid #f0f0f0; }
</style>
