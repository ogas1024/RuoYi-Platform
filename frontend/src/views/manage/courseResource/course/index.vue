  ...
  <div class="app-container">
    ...
    <el-form :inline="true" :model="queryParams" class="mb8">
      ...
      <el-form-item label="课程名">
        <el-input v-model="queryParams.courseName" placeholder="课程名称" style="width: 200px"
    ...
    <el-table v-loading="loading" border stripe :data="list">
      ...
      <el-table-column label="操作" fixed="right" width="180">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="openEdit(scope.row)" v-hasPermi="['manage:course:edit']">
            编辑
          </el-button>
          <el-button link type="danger" icon="Delete" @click="delRow(scope.row)" v-hasPermi="['manage:course:remove']">
            删除
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog v-model="open" :title="form.id?'编辑课程':'新增课程'" width="520px" append-to-body>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="课程名称" prop="courseName">
          <el-input v-model="form.courseName" maxlength="255"/>
        </el-form-item>
        <el-form-item label="课程编码">
          <el-input v-model="form.courseCode" maxlength="64"/>
        </el-form-item>
...
const openAdd = () => {
  Object.assign(form, {id: undefined, majorId: undefined, courseName: '', courseCode: '', status: '0'});
  open.value = true
}
const openEdit = (row) => {
