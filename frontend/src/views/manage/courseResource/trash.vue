  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" border stripe :data="list">
      ...
      <el-table-column label="原因" min-width="240">
        <template #default="scope">
          <span class="reason" v-if="scope.row.status===2 || scope.row.status===3">{{
      ...
      <el-table-column label="操作" fixed="right" width="360">
        <template #default="scope">
          ...
          <el-button link type="success" icon="Top" @click="onlineRow(scope.row)"
                     v-hasPermi="['manage:courseResource:online']">重新上架
          </el-button>
