  ...
  <div class="app-container">
    ...
    <el-form :inline="true" :model="queryParams" class="mb8">
      <el-form-item label="名称">
        <el-input v-model="queryParams.majorName" placeholder="专业名称" style="width: 200px" @keyup.enter="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" border stripe :data="list">
      ...
      <el-table-column label="操作" fixed="right" width="180">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="openEdit(scope.row)" v-hasPermi="['manage:major:edit']">编辑</el-button>
          <el-button link type="danger" icon="Delete" @click="delRow(scope.row)" v-hasPermi="['manage:major:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog v-model="open" :title="form.id?'编辑专业':'新增专业'" width="520px" append-to-body>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="专业名称" prop="majorName"><el-input v-model="form.majorName" maxlength="128"/></el-form-item>
...
const resetQuery = () => { queryParams.majorName = ''; handleQuery() }
const openAdd = () => { Object.assign(form, { id: undefined, majorName: '', status: '0', remark: '' }); open.value = true }
...
const delRow = async (row) => { await delMajor(row.id); proxy.$modal.msgSuccess('删除成功'); getList() }
