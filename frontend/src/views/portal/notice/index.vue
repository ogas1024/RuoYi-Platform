  ...
  <div class="app-container">
    <el-form :inline="true" :model="query" class="mb10">
      <el-form-item label="关键词">
        <el-input v-model="query.keyword" placeholder="搜索标题" clearable @keyup.enter="handleQuery" style="width: 260px" />
      </el-form-item>
      <el-form-item>
        <el-checkbox v-model="query.includeExpired">包含过期</el-checkbox>
      </el-form-item>
      <el-form-item label="已读状态">
        <el-select v-model="query.read" placeholder="全部" clearable style="width: 160px" @clear="() => { query.read = undefined }">
...
const list = ref([])
const total = ref(0)
const query = reactive({ pageNum: 1, pageSize: 10, keyword: '', includeExpired: false, read: undefined, orderBy: 'publishTime', orderDir: 'desc' })
