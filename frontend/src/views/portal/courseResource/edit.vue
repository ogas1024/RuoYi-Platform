...
const formRef = ref()
const form = ref({ id: undefined, resourceName: '', resourceType: 0, fileUrl: '', fileHash: '', fileSize: 0, linkUrl: '', description: '' })
const rules = {
...
const removeFile = () => { form.value.fileUrl = ''; form.value.fileHash = ''; form.value.fileSize = 0 }
const removeLink = () => { form.value.linkUrl = '' }
...
.file-card { display:flex; align-items:center; gap:12px; padding:8px 12px; border:1px solid #ebeef5; border-radius:6px; background:#fafafa; }
